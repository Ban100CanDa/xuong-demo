...
<body class="container">
    ...
    <label class="form-label">Ma san pham chi tiet</label>
    <input class="form-control" type="text" value="${detail.maSPCT}"readonly><br>
    <label class="form-label">Kich thuoc</label>
    <input class="form-control" type="text" value="${detail.idKichThuoc.ten}"readonly><br>
    <label class="form-label">Mau sac</label>
    <input class="form-control" type="text" value="${detail.idMauSac.ten}"readonly><br>
    <label class="form-label">Ten san pham</label>
    <input class="form-control" type="text" value="${detail.idSanPham.ten}"readonly><br>
