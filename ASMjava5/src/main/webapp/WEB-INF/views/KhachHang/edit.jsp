...
<form:form action="/khach-hang/edit" method="post" modelAttribute="fkh">
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="ten" class="form-label">Ten khach hang</label>
        <form:input path="ten" id="ten" class="form-control"/>
        <form:errors path="ten" cssClass="text-danger"/>
    </div>
    <div class="mb-3">
        <label for="maNv" class="form-label">So dien thoai</label>
        <form:input path="sdt" id="maNv" class="form-control"/>
        <form:errors path="sdt" cssClass="text-danger"/>
    </div>
    <div class="mb-3">
        <label for="tenDangNhap" class="form-label">Ma khach hang</label>
        <form:input path="maKh" id="tenDangNhap" class="form-control"/>
